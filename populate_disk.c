...
void write_dzone_info_table(int fd, struct lsdm_sb *sb, int nr_free_blks)
{
	struct stl_dzones_info * entry;
	char buffer[4096];
	int i, j, pzonenr, dzit_entries_per_blk, entries_in_last_blk, ret;
	u64 offset, wp;
...
int main(int argc, char * argv[])
{
	...
	write_dzone_info_table(fd, sb1, nr_free_blks);
